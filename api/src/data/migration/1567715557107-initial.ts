...
export class initial1567715557107 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `review` (`id` int NOT NULL AUTO_INCREMENT, `ratingType` enum ('Awful', 'Bad', 'Average', 'Good', 'Excellent') NOT NULL, `comment` varchar(2000) NOT NULL, `timestamp` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `isDeleted` tinyint NOT NULL DEFAULT 0, `userId` int NULL, `bookId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
