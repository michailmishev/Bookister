...
export class initial1567032759129 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `rating_type` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `review` (`id` varchar(36) NOT NULL, `comment` varchar(2000) NOT NULL, `timestamp` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `isDeleted` tinyint NOT NULL DEFAULT 0, `userId` int NULL, `bookId` varchar(36) NULL, `ratingId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `book` (`id` varchar(36) NOT NULL, `title` varchar(50) NOT NULL, `author` varchar(50) NOT NULL, `topic` varchar(20) NOT NULL, `language` varchar(20) NOT NULL, `timestamp` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `isDeleted` tinyint NOT NULL DEFAULT 0, `averageRating` varchar(20) NOT NULL, `isTaken` tinyint NOT NULL DEFAULT 0, UNIQUE INDEX `IDX_c10a44a29ef231062f22b1b7ac` (`title`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `review` ADD CONSTRAINT `FK_7be60911e4cb51dd9b2155c0f0f` FOREIGN KEY (`ratingId`) REFERENCES `rating_type`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `review` DROP FOREIGN KEY `FK_7be60911e4cb51dd9b2155c0f0f`");
