...
export class initial1565905196226 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `library_event` ADD CONSTRAINT `FK_743c27ad302a4be06f229fb9483` FOREIGN KEY (`nameId`) REFERENCES `library_event_type`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `library_event` DROP FOREIGN KEY `FK_743c27ad302a4be06f229fb9483`");
