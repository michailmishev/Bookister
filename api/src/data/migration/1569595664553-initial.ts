...
export class initial1569595664553 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `review` (`id` int NOT NULL AUTO_INCREMENT, `ratingType` enum ('1', '2', '3', '4', '5') NOT NULL, `comment` varchar(2000) NOT NULL, `timestamp` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `isDeleted` tinyint NOT NULL DEFAULT 0, `userId` int NULL, `bookId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `user_allowed_to_review` (`id` int NOT NULL AUTO_INCREMENT, `timestamp` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `isAllowedToReview` tinyint NOT NULL DEFAULT 0, `userId` int NULL, `bookId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `library_event` (`id` int NOT NULL AUTO_INCREMENT, `borrowType` enum ('Taken', 'Returned') NOT NULL, `timestamp` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `userId` int NULL, `bookId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `book` (`id` int NOT NULL AUTO_INCREMENT, `title` varchar(50) NOT NULL, `author` varchar(50) NOT NULL, `topic` varchar(20) NOT NULL, `language` varchar(20) NOT NULL, `timestamp` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `isDeleted` tinyint NOT NULL DEFAULT 0, `averageRating` varchar(255) NULL DEFAULT null, `isTaken` tinyint NOT NULL DEFAULT 0, `takenBy` varchar(255) NULL DEFAULT null, UNIQUE INDEX `IDX_c10a44a29ef231062f22b1b7ac` (`title`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `user_allowed_to_review` ADD CONSTRAINT `FK_5f91b735ba5df923954b998bfa4` FOREIGN KEY (`userId`) REFERENCES `user`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `user_allowed_to_review` ADD CONSTRAINT `FK_f1a716755e0e59306e85848ad00` FOREIGN KEY (`bookId`) REFERENCES `book`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `user_allowed_to_review` DROP FOREIGN KEY `FK_f1a716755e0e59306e85848ad00`");
        await queryRunner.query("ALTER TABLE `user_allowed_to_review` DROP FOREIGN KEY `FK_5f91b735ba5df923954b998bfa4`");
        ...
        await queryRunner.query("DROP TABLE `user_allowed_to_review`");
