...
export class initial1567945080223 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `book` (`id` int NOT NULL AUTO_INCREMENT, `title` varchar(50) NOT NULL, `author` varchar(50) NOT NULL, `topic` varchar(20) NOT NULL, `language` varchar(20) NOT NULL, `timestamp` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `isDeleted` tinyint NOT NULL DEFAULT 0, `averageRating` varchar(255) NULL DEFAULT null, `isTaken` tinyint NOT NULL DEFAULT 0, UNIQUE INDEX `IDX_c10a44a29ef231062f22b1b7ac` (`title`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
