...
exports.AuthGuard = memoize_util_1.memoize(createAuthGuard);
...
function createAuthGuard(type) {
    let MixinAuthGuard = class MixinAuthGuard {
        ...
        canActivate(context) {
            return __awaiter(this, void 0, void 0, function* () {
                const options = Object.assign({}, options_1.defaultOptions, this.options);
                const [request, response] = [
                    this.getRequest(context),
                    context.switchToHttp().getResponse()
                ];
                const passportFn = createPassportContext(request, response);
                const user = yield passportFn(type || this.options.defaultStrategy, options, (err, info, user) => this.handleRequest(err, info, user));
    ...
    const guard = common_1.mixin(MixinAuthGuard);
    return guard;
}
