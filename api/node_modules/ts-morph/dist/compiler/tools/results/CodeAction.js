...
var CodeAction = /** @class */ (function () {
    /** @private */
    function CodeAction(context, compilerObject) {
        this._context = context;
        this._compilerObject = compilerObject;
    }
    Object.defineProperty(CodeAction.prototype, "compilerObject", {
    ...
    CodeAction.prototype.getDescription = function () {
        return this.compilerObject.description;
    };
    /** Text changes to apply to each file as part of the code action. */
    CodeAction.prototype.getChanges = function () {
        var _this = this;
